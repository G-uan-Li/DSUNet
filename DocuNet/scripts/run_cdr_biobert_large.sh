...
python -u  ./train_bio.py --data_dir ./dataset/cdr \
  ...
  --seed 111 \
  --num_class 2 \
  --save_path ./checkpoint/cdr/train_biobertlarge-lr${bl}_accum${accum}_unet-lr${ul}_bs${bs}.pt \
  --log_dir ./logs/cdr/train_biobertlarge-lr${bl}_accum${accum}_unet-lr${ul}_bs${bs}.log
done
fi
