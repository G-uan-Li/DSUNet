...
python -u  ./train_bio.py --data_dir ./dataset/cdr \
  ...
  --model_name_or_path /root/autodl-tmp/allenai-scibert_scivocab_cased \
  ...
  --log_dir ./logs/cdr/train_scibert_accum${accum}_lr${ul}_bs${bs}.log
done
fi
